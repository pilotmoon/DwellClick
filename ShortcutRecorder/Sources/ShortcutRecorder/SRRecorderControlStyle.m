                              ...
                              tint:(SRRecorderControlStyleComponentsTint)aTint
{
    ...
    NSAssert(anAccessibility == SRRecorderControlStyleComponentsAccessibilityNone || (anAccessibility & SRRecorderControlStyleComponentsAccessibilityNone) == 0, @"None cannot be combined with other accessibility options.");
    NSAssert(aDirection >= SRRecorderControlStyleComponentsLayoutDirectionUnspecified && aDirection < SRRecorderControlStyleComponentsLayoutDirectionMax,
...
- (BOOL)isSpecified
{
    return _appearance != SRRecorderControlStyleComponentsAppearanceUnspecified && _accessibility != SRRecorderControlStyleComponentsAccessibilityUnspecified && _layoutDirection != SRRecorderControlStyleComponentsLayoutDirectionUnspecified && _tint != SRRecorderControlStyleComponentsTintUnspecified;
}
...
- (BOOL)isEqualToComponents:(SRRecorderControlStyleComponents *)anObject
{
    if (anObject == self)
        ...
        return self.appearance == anObject.appearance && self.accessibility == anObject.accessibility && self.layoutDirection == anObject.layoutDirection && self.tint == anObject.tint;
}
...
- (NSUInteger)hash
{
    ...
    return self.tint | (self.layoutDirection << tintBitSize) | (self.appearance << (tintBitSize + layoutDirectionBitSize)) | (self.accessibility << (tintBitSize + layoutDirectionBitSize + appearanceBitSize));
}
...
- (void)addConstraints
{
    ...
    _alwaysConstraints = @[
        ...
        SetConstraint(&_backgroundTopConstraint, MakeEqConstraint(self.alignmentGuide.topAnchor, self.backgroundDrawingGuide.topAnchor, @"SR_backgroundDrawingGuide_topToAlignment")),
        SetConstraint(&_backgroundLeftConstraint, MakeEqConstraint(self.alignmentGuide.leftAnchor, self.backgroundDrawingGuide.leftAnchor, @"SR_backgroundDrawingGuide_leftToAlignment")),
        SetConstraint(&_backgroundBottomConstraint, MakeEqConstraint(self.backgroundDrawingGuide.bottomAnchor, self.alignmentGuide.bottomAnchor, @"SR_backgroundDrawingGuide_bottomToAlignment")),
        SetConstraint(&_backgroundRightConstraint, MakeEqConstraint(self.backgroundDrawingGuide.rightAnchor, self.alignmentGuide.rightAnchor, @"SR_backgroundDrawingGuide_rightToAlignment")),

        MakeEqConstraint(self.labelDrawingGuide.topAnchor,
            self.alignmentGuide.topAnchor,
            @"SR_labelDrawingGuide_topToAlignment"),
        SetConstraint(&_alignmentToLabelConstraint, MakeGteConstraint(self.labelDrawingGuide.leadingAnchor, self.alignmentGuide.leadingAnchor, @"SR_labelDrawingGuide_leadingToAlignment")),
    ...
    _displayingConstraints = @[
        SetConstraint(&_labelToAlignmentConstraint, MakeGteConstraint(self.alignmentGuide.trailingAnchor, self.labelDrawingGuide.trailingAnchor, @"SR_labelDrawingGuide_trailingToAlignment")),
    ];

    _recordingWithNoValueConstraints = @[
        SetConstraint(&_labelToCancelConstraint, MakeGteConstraint(self.cancelButtonDrawingGuide.leadingAnchor, self.labelDrawingGuide.trailingAnchor, @"SR_labelDrawingGuide_trailingToCancel")),

        SetConstraint(&_cancelToAlignmentConstraint, MakeEqConstraint(self.alignmentGuide.trailingAnchor, self.cancelButtonDrawingGuide.trailingAnchor, @"SR_cancelButtonDrawingGuide_trailingToAlignment")),
        ...
        SetConstraint(&_cancelButtonWidthConstraint, MakeEqConstraint(self.cancelButtonDrawingGuide.widthAnchor, nil, @"SR_cancelButtonDrawingGuide_width")),
        SetConstraint(&_cancelButtonHeightConstraint, MakeEqConstraint(self.cancelButtonDrawingGuide.heightAnchor, nil, @"SR_cancelButtonDrawingGuide_height")),
    ...
    _recordingWithValueConstraints = @[
        ...
        SetConstraint(&_cancelToClearConstraint, MakeEqConstraint(self.clearButtonDrawingGuide.leadingAnchor, self.cancelButtonDrawingGuide.trailingAnchor, @"SR_cancelButtonDrawingGuide_trailingToClear")),
        ...
        SetConstraint(&_clearToAlignmentConstraint, MakeEqConstraint(self.alignmentGuide.trailingAnchor, self.clearButtonDrawingGuide.trailingAnchor, @"SR_clearButtonDrawingGuide_trailingToAlignment")),
        SetConstraint(&_clearButtonWidthConstraint, MakeEqConstraint(self.clearButtonDrawingGuide.widthAnchor, nil, @"SR_clearButtonDrawingGuide_width")),
        SetConstraint(&_clearButtonHeightConstraint, MakeEqConstraint(self.clearButtonDrawingGuide.heightAnchor, nil, @"SR_clearButtonDrawingGuide_height")),
...
- (void)recorderControlAppearanceDidChange:(nullable id)aReason
{
    ...
    if (!_currentLookupPrefixes) {
        ...
        CGFloat maxExpectedTrailingLabelOffset = fmax(_labelToAlignmentConstraint.constant,
            _labelToCancelConstraint.constant + _cancelButtonWidthConstraint.constant + _cancelToClearConstraint.constant + _clearButtonWidthConstraint.constant + _clearToAlignmentConstraint.constant);
