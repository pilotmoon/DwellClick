              ...
              usingTransformer:(SRKeyCodeTransformer *)aTransformer
{
    ...
    if (self.keyCode == SRKeyCodeTab && self.modifierFlags == aModifierFlags && aKeyEquivalent.length == 1 && ([aKeyEquivalent characterAtIndex:0] == NSTabCharacter || [aKeyEquivalent characterAtIndex:0] == NSBackTabCharacter)) {
        return YES;
    }
