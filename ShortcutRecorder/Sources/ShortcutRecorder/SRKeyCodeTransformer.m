...
{
    return self.keyCode == anObject.keyCode && self.explicitModifierFlags == anObject.explicitModifierFlags && self.implicitModifierFlags == anObject.implicitModifierFlags &&
...
- (NSUInteger)hash
{
    ...
    return keyCodeHash | (implicitFlagsHash << keyCodeBitSize) | (explicitFlagsHash << (keyCodeBitSize + implicitFlagsBitSize)) | (identifierHash << (keyCodeBitSize + implicitFlagsBitSize + explicitFlagsBitSize));
}
